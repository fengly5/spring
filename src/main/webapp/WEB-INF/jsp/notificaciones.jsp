<%-- 
    ...
    Created on : 04-mar-2018, 17:25:31
    Author     : jcpm0
--%>
          ...
          <div class="card "><!-- card -->
            ...
            <div class="card-body"><!-- card boy -->
              ...
              <div class="row table-responsive-md"> <!-- Tabla -->
                ...
                <tbody>
                <c:forEach items="${notificaciones}" var="notif" >
                 <tr>
                   <th scope="row"><c:out value="${notif.fecha}"></c:out>
                   </th>
                   <c:forEach items="${notif.notif_sistema}" var="notif_sistema">
                   <td><c:out value="${notif_sistema.tipo_notif.tipo}"></c:out></td>
                   </c:forEach>
                   <td><c:out value="${notif.mensaje}"></c:out>
                   </td>
                   <td>
                    <c:choose>
                     <c:when test="${notif.entregada == 1}">
               ...
               <tag:paginate max="10" offset="${offset}" count="${count}"
                 uri="notificaciones.htm" next="&raquo;" previous="&laquo;" />
             </div> <!-- card boy -->
          </div><!-- card -->
        </div><!-- col -->
        </div>
